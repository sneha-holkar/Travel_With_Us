                        ...
                        <form  method="post" >
                            <div class="form-row">
                                <div class="control-group col-sm-6">
                                    <input type="date" class="form-control py-2 px-4" id="sdate" name="sdate" placeholder="Depart Date"
                                        required="required" data-validation-required-message="Please enter date" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group col-sm-6">
                                    <input type="email" class="form-control py-2 px-4" id="edate" value="" name="edate " placeholder="Return Date"
                                        required="required" data-validation-required-message="Please enter date" readonly />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                             <div class="form-row">
                                <div class="control-group col-sm-6">
                                    <input type="date" class="form-control py-2 px-4" id="sloc" name="sloc" placeholder="Starting Location"
                                ...
                                <div class="control-group col-sm-6">
                                    <input type="text" class="form-control py-2 px-4" id="eloc" value="" name="eloc " placeholder="Destination"
                                        required="required" data-validation-required-message="Please enter location" readonly />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="form-row">
